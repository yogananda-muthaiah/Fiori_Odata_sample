		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order List",
									"targetURL": "#comaccentureorderlistapp004-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaccentureorderlistapp004-display": {
								"semanticObject": "comaccentureorderlistapp004",
								"action": "display",
								"description": "An SAP Fiori application with Northwind service",
								"title": "Order List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.accenture.orderlist.app004",
									"url": sap.ui.require.toUrl("com/accenture/orderlist/app004")
								}
							}
						}
					}
