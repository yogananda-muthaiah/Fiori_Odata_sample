		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order List",
									"targetURL": "#comaccentureordersapp003-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaccentureordersapp003-display": {
								"semanticObject": "comaccentureordersapp003",
								"action": "display",
								"description": "An SAP Fiori application with oData",
								"title": "Order List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.accenture.orders.app003",
									"url": sap.ui.require.toUrl("com/accenture/orders/app003")
								}
							}
						}
					}
