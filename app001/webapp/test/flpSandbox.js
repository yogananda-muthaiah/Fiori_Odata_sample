		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comaccentureempleadosapp001-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaccentureempleadosapp001-display": {
								"semanticObject": "comaccentureempleadosapp001",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.accenture.empleados.app001",
									"url": sap.ui.require.toUrl("com/accenture/empleados/app001")
								}
							}
						}
					}
